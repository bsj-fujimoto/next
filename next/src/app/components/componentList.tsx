...
export const componentList: ComponentItem[] = [
  ...
  },
  {
    ...
    description: "グラデーション背景とアニメーション効果を提供するコンポーネントです。",
    icon: (
      <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    name: "FormInput",
    title: "FormInput",
    description: "アイコン付きのフォーム入力フィールドコンポーネントです。",
    icon: (
      <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    name: "Header",
    title: "Header",
    description: "ダッシュボードのヘッダーコンポーネントです。",
    icon: (
      <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    name: "StatCard",
    title: "StatCard",
    description: "統計情報を表示するカードコンポーネントです。",
    icon: (
      <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    name: "StatusBadge",
    title: "StatusBadge",
    description: "ステータスを表示するバッジコンポーネントです。",
    icon: (
      <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    name: "Toast",
    title: "Toast",
    description: "通知メッセージを表示するトースト（スナックバー）コンポーネントです。",
    icon: (
      <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
      </svg>
  ...
  },
  {
    ...
    description: "アバターアイコンとドロップダウンメニューを組み合わせたコンポーネントです。プロフィール、セッティング、ログアウトへのアクセスを提供します。",
    icon: (
      <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
