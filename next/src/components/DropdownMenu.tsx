    ...
    <div className={`relative ${className}`} ref={dropdownRef}>
      ...
      {isOpen && (
        <div
          ...
          className={`absolute ${align === "right" ? "right-0" : "left-0"} top-full mt-1 z-50 min-w-full rounded-lg border border-gray-200 shadow-xl overflow-hidden bg-white ${menuClassName}`}
        >
